...
curl_setopt($c, CURLOPT_HEADER, false);		//true - return the HTTP headers as part of the text, false - NO headers

curl_setopt($c, CURLOPT_RETURNTRANSFER, true);			//I want the page returned as a string	- if false then it returns 1 or 0
